...
CREATE TABLE `room` (
  ...
  `submit_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1190 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1443 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
