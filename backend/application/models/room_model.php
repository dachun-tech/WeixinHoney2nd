...
class room_model extends CI_Model
{
    ...
    {
        $this->db->select("count(room.boss_id) as edit_state");
        $this->db->from("room");
        $this->db->join("room_booking", "room_booking.room_id=room.id");
